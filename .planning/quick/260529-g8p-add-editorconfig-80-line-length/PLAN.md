...
- TypeScript/JS (_.ts, _.js): 2-space indent, max_line_length = 80
- Markdown (\*.md): 2-space indent, max_line_length = 80, no trim trailing WS
- JSON (\*.json): 2-space indent
- YAML (_.yaml, _.yml): 2-space indent
- Makefile: tab indent
...
Single atomic commit: "chore: add EditorConfig, configure 80-char line width,
reformat sources"
