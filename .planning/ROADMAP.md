...
- [x] 15-02-PLAN.md — websocket: remove reset_room_to_default_zone_program
      command, add set_room_config room_mode silent drop, update WS tests
      (ARCH-02)
...
**Plans**: 7 plans
- [x] 16-01-PLAN.md — Wave 0 RED test scaffolds: test_eval_context,
      test_zone, test_person, test_room_domain (OBS-01)
- [x] 16-02-PLAN.md — eval_context.py: EvalContext dataclass, lazy per-cycle
...
- [ ] 17-01-PLAN.md — Screenshot tooling: OUTPUT_DIR/HARNESS_PATH env-var
...
| 17. Person Scheduling Use-Case Docs         | v1.3      | 0/3            | Pending  | —          |
